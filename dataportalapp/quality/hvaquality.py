...
def h014():
    ...
    df_014 = df_014[~df_014['vervaardiging.datum.begin'].str.contains(r"\$", na=False)]
...
def h026():
    ...
    search = [r'\$Antwerpen', r'Antwerpen\$']
    ...
    search = [r'\$Amsterdam', r'Amsterdam\$']
